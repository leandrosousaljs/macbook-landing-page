...
Files: macbook-14.glb [629.72KB] > E:\Projects\macbook-landing-page\public\models\macbook-14-transformed.glb [627.9KB] (0%)
...
export default function MacbookModel14(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF('/models/macbook-14-transformed.glb') as GLTFResult;
